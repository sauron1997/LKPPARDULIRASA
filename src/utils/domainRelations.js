export const ACCOUNT_STORAGE_KEY = 'lkp-domain-accounts';
export const COURSE_STORAGE_KEY = 'lkp-domain-courses';
export const ENROLLMENT_STORAGE_KEY = 'lkp-domain-enrollments';
export const MODULE_STORAGE_KEY = 'lkp-domain-modules';
export const ASSESSMENT_PROGRESS_STORAGE_KEY = 'lkp-domain-assessment-progress';
export const ASSESSMENT_DEFINITION_STORAGE_KEY = 'lkp-domain-assessment-definitions';
export const ASSESSMENT_SUBMISSION_STORAGE_KEY = 'lkp-domain-assessment-submissions';
export const STUDENT_STORAGE_KEY = 'lkp-domain-students';
export const CLASSROOM_POST_STORAGE_KEY = 'lkp-domain-classroom-posts';
export const CLASSWORK_ITEM_STORAGE_KEY = 'lkp-domain-classwork-items';
