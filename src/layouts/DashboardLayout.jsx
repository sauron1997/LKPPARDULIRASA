...
export default function DashboardLayout() {
  ...
  return (
    <div className="student-dashboard-layout isolate flex min-h-screen bg-[#0d5a45] text-gray-900 font-sans">
      <Sidebar
        type="student"
        collapsed={collapsed}
      ...
      <div className={`admin-main-shell relative flex min-h-screen min-w-0 flex-1 flex-col ${collapsed ? 'is-collapsed' : ''}`}>
        <div className="absolute inset-0 overflow-hidden bg-[#f4f8f4]">
          <div className="absolute left-[-120px] top-[-100px] h-[260px] w-[260px] rounded-full bg-emerald-100/70 blur-3xl" />
          <div className="absolute right-[-80px] top-16 h-[220px] w-[220px] rounded-full bg-teal-100/50 blur-3xl" />
          <div className="absolute bottom-[-120px] left-1/3 h-[220px] w-[220px] rounded-full bg-lime-100/45 blur-3xl" />
        </div>
        ...
        <header className="sticky top-0 z-20 border-b border-slate-200/70 bg-[#f4f8f4]/88 backdrop-blur-xl lg:hidden">
          <div className="mx-auto flex w-full max-w-[1520px] items-center gap-3 px-4 py-3 sm:px-6">
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold text-slate-800">Dashboard Siswa</p>
